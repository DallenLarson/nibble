...
- 1.0.1 in the project file, the app manifest, the menu and the page footer.
- `tools/package.ps1` builds `dist/Nibble.exe` (2.2 MB) and `dist/Nibble-1.0.1-Setup.exe`.
...
- [x] **Publish the repository.** `DallenLarson/nibble`, public, MIT, tagged `v1.0.1`.
